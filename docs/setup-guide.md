# Collab Canvas Setup Guide

## Overview

This comprehensive guide covers setting up the Collab Canvas application with all Phase 1-3 features including:
- Multi-shape collaborative canvas (rectangles, circles, lines, text)
- AI-powered natural language control (OpenAI GPT-4o)
- Google Authentication with user profiles  
- Comments system
- Advanced features (rotation, alignment, lasso selection)
- Production-grade security rules

**Quick Start:** For a condensed setup, see the [README](../README.md).  
**Architecture:** For technical details, see the [Architecture Documentation](architecture.md).
...
2. Click "Get started"
3. Select **Google** under "Sign-in method"
4. Toggle "Enable"
5. Set support email and click "Save"
6. (Optional) Also enable **Anonymous** for development/testing
